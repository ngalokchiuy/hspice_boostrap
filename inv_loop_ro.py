...
if __name__=="__main__":
    ...
    if args.write_deck: 
        build.write_inv_loop(output_file="sp/inv_loop_21x.sp", input_rise_time=5.7, K=1.3)
    ...
    if args.write_deck: 
        build.write_inv_loop(output_file="sp/inv_loop_3x.sp", input_rise_time=5.7, K=1.3, inv_count=3)
